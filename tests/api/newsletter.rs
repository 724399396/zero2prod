...
async fn newsletters_are_not_delivered_to_unconfirmed_subscribers() {
    ...
    create_uncofirmed_subscriber(&app).await;
...
async fn create_uncofirmed_subscriber(app: &TestApp) -> ConfirmationLinks {
...
async fn create_confirmed_subscriber(app: &TestApp) {
    let confirmation_link = create_uncofirmed_subscriber(app).await;
